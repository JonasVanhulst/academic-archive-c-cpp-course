...
//```
// Als uitbreiding op deze oefening kan je ervoor zorgen dat er verschillende
// startdatums toegevoegd kunnen worden.
// Dit kan dan gebruikt worden om bijvoorbeeld de datum 1-1-2023 mee te geven
// gevolgd door 31 waarden voor de temperatuur en neerslag. Vervolgens kan je
// dan de datum 1-2-2023 meegeven gevolgd door 28 waarden voor de temperatuur en
// neerslag.
//
