...
// maximum, het gemiddelde en de mediaan berekend kan worden. Implementeer deze
// functionaliteit in de volgende functie:
//```c
// void statistiek(int *numbers, int size, int *min, int *max, int *average, int
// *median)
//```
// Print de lijst met nummers af voordat je de functie oproept en nadat je de
// functie hebt opgeroepen. Maak gebruik van de functies malloc() en memcpy() om
// de lijst met nummers te kopiëren. Sorteer vervolgens de gekopieerde lijst met
// nummers van klein naar groot. Haal uit deze gesorteerde lijst het minimum,
// het maximum en de mediaan. Het gemiddeld kan je vinden door over de lijst te
// itereren en zo het gemiddelde te berekenen. Zorg er tot slot voor dat het
// gealloceerde geheugen terug wordt vrijgegeven voordat je de functie verlaat.
...
void statistiek(int* numbers, int size, int* min, int* max, float* average,
                float* median);
...
int minValue(int* numbers) { return numbers[0]; }

// Function to get te maximum number
int maxValue(int* numbers, int size) { return numbers[size - 1]; }
