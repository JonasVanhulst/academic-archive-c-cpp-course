...
//
//Herschrijf oefening 1 van week 3 waarbij de struct statistiek temperatuur en neerslag allebei op de heap gealloceerd worden.
//Zorg er ook voor dat de lijst in de struct statistiek een pointer naar een array is waarvan het geheugen dynamisch gealloceerd wordt.
//Zorg ervoor dat er geen memory leak is als je het programma beëindigd.
