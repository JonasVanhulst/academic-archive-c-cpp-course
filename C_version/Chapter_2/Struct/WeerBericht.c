...
// Bron : https://www.meteo.be/nl/klimaat/klimaat-van-belgie/recente-waarnemingen-te-ukkel
// Start met de gegevens die staan in
// https://www.meteo.be/resources/climatology/uccle_month/Ukkel_waarnemingen.txt
// en verzamel die in een struct per maand per gegevenstype (i.e. gemiddelde temperatuur en neerslag).
// Maak een functie dat de cumul en een functie dat gemiddelde kan berekenen van een meegegeven struct.
//
...
int main(void) {
    struct statistiek temperatuur = {"Gemiddeld temperatuur", "°C", totalDay,
                                     {
                                             {{20, 2, 2023}, 7},
                                             {{19, 2, 2023}, 8.5},
                                             {{18, 2, 2023}, 9.9},
    ...
    struct statistiek neerslag = {"Neerslag", "mm", totalDay,
                                  {
                                          {{20, 2, 2023}, 0},
                                          {{19, 2, 2023}, 0},
                                          {{18, 2, 2023}, 2.5},
