...
// welk jaar van de bachelor (1ste bachelor, 2de bachelor, 3de bacholor of
// geïndividualiseerd traject) en het huidige academiejaar (i.e. 2022-2023).
// Definieer een enum om het jaar van de bachelor mee aan te duiden.
//
// Als het programma wordt uitgevoerd kan de gebruiker het studentennummer,
// studierichting, jaar van de bachelor en huidig academiejaar ingevoerd worden.
// Deze gegevens worden opgeslagen in een variabele van het datatype struct
// student.
//
...
int main() {
  ...
  schoolInformation.bachelorYear = gender == first_bachelor    ? first_bachelor
                                   : gender == second_bachelor ? second_bachelor
                                                               : third_bachelor;
  ...
  printf(
      ...
      "Years: \t\t %d - %d\n| Your status: \t\t %c",
      schoolInformation.school, schoolInformation.studentNumber,
      schoolInformation.school, schoolInformation.studentClass,
      schoolInformation.startedsStudentYear, schoolInformation.lastStudentYear,
      gender);
