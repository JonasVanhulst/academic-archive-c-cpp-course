      ...
      if (token != NULL) {
        if (strcmp(token, "count") == 0) {
          ...
          spellList.results[counter].URL =
              (char*)calloc(strlen(url), sizeof(char));
