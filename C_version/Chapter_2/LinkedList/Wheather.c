...
//Wel dien je gebruik te maken van een linked list structuur (die werkt als een FIFO buffer) in plaats van een array in de struct statistiek.
//Hierin hou je de data van de laatste 2 maanden bij. Deze data wordt toegevoegd aan de linked list d.m.v. de AddValue() functie(s).
//Zodra er data wordt toevoegd die tot een nieuwe maand behoort, en er al twee maanden bestaan, dan wordt de oudste maand verwijderd.
//Voordat je deze data verwijdert bereken je eerst de cumul en het gemiddelde van de temperatuur en neerslag van die maand.
