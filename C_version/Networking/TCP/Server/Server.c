...
void execution(int internet_socket) {
  ...
  if (number_of_bytes_received == -1) {
    ...
    switch (operator) {
      ...
      case '*':
        ...
        break;
      case '/':
        solution = (float)first / (float)second;
        break;
  ...
  snprintf(float_mathSolution, sizeof(float_mathSolution), "%f", solution);
  number_of_bytes_send =
      send(internet_socket, float_mathSolution, sizeof(float_mathSolution), 0);
