...
//
// Maak een wachtwoord generator die een willekeurig wachtwoord genereert van 10 karakters.
// Zorg ervoor dat het wachtwoord minstens 1 hoofdletter, 1 cijfer en 1 speciaal teken ( !"#$%&'()*+ ) bevat.
//
// ```
